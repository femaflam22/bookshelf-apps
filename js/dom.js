...
function makeReadingList(bTitle, bWraiter, bYear, bTimestamp, isCompleted) {
    ...
    writer.classList.add("wraiter_book");
    ...
    if (isCompleted) {
        ...
        bookContainerAction.append(createEditButton(), createCheckButton());
    }
...
function addBookToCompleted(bookElement) {
    ...
    const bookWriter = bookElement.querySelector(".wraiter_book").innerText;
...
function editBookInfo(bookElement) {
    ...
    document.getElementById("inputBookAuthor").value = bookElement.querySelector(".wraiter_book").innerText;
